      ...
      {submitForm ?
        <div className="border-2 shadow-md rounded-md w-11/12 md:w-1/2 border-gray-200 px-8 py-10 flex flex-col">
          ...
          <div className="pt-4 mb-4">
            <p className="my-2 text-sm">You're about to make a reservation at <span className="text-blue-800 font-bold">{submitForm.location}</span>. Please select your room.</p>
          </div>
          <form
          ...
          >
            {/* <div className='w-full flex justify-between items-center mb-4'>
              ...
              <input type='date' name='checkIn' className='w-2/3 px-4 py-2 border border-gray-200 rounded-md text-center'  onChange={changeHandler} />
            </div>
            <div className='w-full flex justify-between items-center mb-4'>
              <label htmlFor='checkOut'>
                Check Out:
              </label>
              <input type='date' name='checkOut' className='w-2/3 px-4 py-2 border border-gray-200 rounded-md text-center'  onChange={changeHandler} />
            </div>
